...
const MonthYearPicker: React.FC<MonthYearPickerProps> = ({
    ...
    return (
        <div className={`relative ${className}`} ref={dropdownRef}>
            ...
            {/* 드롭다운 메뉴 */}
            {isOpen && (
                <div className="absolute top-full left-0 right-0 mt-[1vh] bg-basic-black-gray rounded-[1rem] shadow-lg z-50 max-h-[50vh] overflow-hidden">
                    <div className="p-[4vw]">
                        {/* 년도 선택 섹션 */}
                        <div className="mb-[3vh]">
                            <h3 className="text-gray-400 text-[0.875rem] mb-[2vh]">년도</h3>
