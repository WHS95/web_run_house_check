    ...
    return (
      <div className='space-y-3'>
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className='bg-rh-bg-surface rounded-xl p-4'>
                      ...
                      <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          <Button
                            ...
                            className='p-1 w-8 h-8 text-white transition-transform duration-200 sm:h-6 sm:w-6'
                          >
                            <ChevronRight
                  ...
                  >
                    <div className='pt-3 mt-3 border-t border-rh-border'>
                      <div className='grid grid-cols-1 gap-3 text-sm text-rh-text-secondary sm:grid-cols-2'>
                        ...
                        <div className='flex justify-between'>
                          <span className='font-bold text-white'>가입일</span>
