...
const CrewEditForm = memo(function CrewEditForm({
    ...
    const handleCropConfirm = useCallback(
        async (blob: Blob) => {
            ...
            try {
                ...
                if (updateError) {
                    console.error(
                        "[crew-edit] logo DB update failed:",
                        updateError,
                    );
                    alert(
                        `로고 저장에 실패했습니다.\n${updateError.message ?? ""}`,
                ...
                if (prevUrl && prevUrl !== publicUrl) {
                    ...
                    if (
                        ...
                        if (removeError) {
                            ...
                            console.error(
                                "[crew-edit] old logo remove failed:",
                                removeError,
                            );
                        }
                    }
                ...
                console.error(
                    "[crew-edit] unexpected logo error:",
                    err,
                );
                const message =
    ...
    const handleSave = useCallback(async () => {
        ...
        try {
            ...
            console.error(
                "[crew-edit] unexpected save error:",
                err,
            );
            const message =
                err instanceof Error
