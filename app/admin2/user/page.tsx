...
function UserListSkeleton() {
    return (
        <div className="flex-1 px-4 pt-4 space-y-4">
            <div className="h-12 bg-rh-bg-surface rounded-[12px] animate-pulse" />
            <div className="flex justify-between items-center">
                <div className="w-20 h-4 bg-rh-bg-muted rounded animate-pulse" />
                <div className="w-14 h-8 bg-rh-bg-surface rounded animate-pulse" />
            </div>
            {[1, 2, 3].map((i) => (
                <div
                    key={i}
                    className="h-16 bg-rh-bg-surface rounded-[12px] animate-pulse"
                />
            ))}
        </div>
    );
