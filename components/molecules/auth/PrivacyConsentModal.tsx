      ...
      <div className='bg-white rounded-lg max-w-md w-full mx-4 max-h-[80vh] overflow-hidden'>
        ...
        <div className='p-4 overflow-y-auto max-h-[60vh]'>
          <div className='space-y-4 text-sm text-rh-text-muted'>
            ...
            <div>
              <h3 className='mb-2 font-semibold text-rh-text-inverted'>1. 수집 항목</h3>
              ...
              <p className='mt-2 text-xs text-rh-text-muted'>
        ...
        <div className='p-4 border-t border-rh-border'>
          <button
            onClick={onClose}
            className='w-full px-4 py-2 text-white rounded-md bg-rh-accent hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-primary-blue'
          >
            확인
          </button>
        </div>
